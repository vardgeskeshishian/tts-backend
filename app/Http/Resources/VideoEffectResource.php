...
/**
 * @OA\Schema(
 *     schema="VideoEffectResource",
 *     title="VideoEffectResource",
...
class VideoEffectResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'meta_title' => $res->meta_title ?? str_replace('%Track_Name%', $res->name, $template->metaTitle),
            'meta_description' => $res->meta_description ?? str_replace('%Track_Name%', $res->name, $template->metaDescription),
