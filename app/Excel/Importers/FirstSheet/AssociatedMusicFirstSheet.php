...
class AssociatedMusicFirstSheet implements WithHeadingRow, WithProgressBar, WithCalculatedFormulas, OnEachRow
{
    use Importable;
    ...
    public function onRow(Row $row)
    {
        ...
        return $this->effectsService->updateVideoEffectFields($rowData, ['associated_music' => 'music_url']);
    }
}
