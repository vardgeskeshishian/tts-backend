...
namespace App\Orchid\Layouts\Category\Music\Tag;
        ...
        return [
            ...
            TD::make('h1', __('H1'))
                ...
                ->render(function (Tag $tag) {
                    $templateMeta = TemplateMeta::where('type', Tag::class)->first();
            ...
            TD::make(__('Actions'))
                ...
                ->render(fn (Tag $tag) => DropDown::make()
                    ...
                    ->list([
                        ...
                        Link::make(__('Edit'))
                            ->route('platform.systems.category.music.tag.edit', $tag->id)
                            ->icon('bs.pencil'),
