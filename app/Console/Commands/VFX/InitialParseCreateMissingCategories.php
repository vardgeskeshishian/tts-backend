...
use App\Excel\Importers\FirstSheet\MissingCategoriesFirstSheet;

class InitialParseCreateMissingCategories extends InitialParse
{
    /**
     ...
     * @var string
     */
    protected $signature = 'vfx:parser:initial:create-missing-categories
    ...
    protected string $templateClassName = MissingCategoriesFirstSheet::class;
}
